  ...
  return (
    <div className="min-h-screen w-full bg-coffee-bg">
      ...
      <section className="relative flex h-screen w-full items-center justify-center overflow-hidden">
        ...
        {/* HUGE VISIBLE Animated Radial Glow */}
        ...
        {/* VERY Large and Visible Floating Particles */}
        ...
        <div className="relative z-10 flex flex-col items-center justify-center px-6 text-center">
          ...
          <div className="mb-16 space-y-4">
            <h1 className="font-display text-7xl font-bold tracking-wider text-white md:text-8xl lg:text-9xl">
              PAUSE CAFÉ
            </h1>
            <div className="flex items-center justify-center gap-4">
              <div className="h-px w-16 bg-gradient-to-r from-transparent to-coffee-orange" />
              <h2 className="font-display text-4xl font-light tracking-[0.3em] text-coffee-orange md:text-5xl">
                SOLEIL
              </h2>
              <div className="h-px w-16 bg-gradient-to-l from-transparent to-coffee-orange" />
            </div>
          </div>

          {/* Tagline */}
          <p className="mb-14 max-w-2xl text-xl font-light text-coffee-gray/90">
          ...
          <div className="flex flex-col gap-5 sm:flex-row sm:gap-8">
            <Link
              href="/support"
              className="group relative overflow-hidden bg-coffee-orange px-12 py-5 text-lg font-semibold text-coffee-bg transition-all duration-500 hover:scale-105 hover:bg-coffee-orange/90 hover:shadow-[0_8px_30px_rgba(243,164,36,0.4)]"
            >
              <span className="relative z-10">Support & Entretien</span>
              <div className="absolute inset-0 -translate-x-full bg-gradient-to-r from-transparent via-white/20 to-transparent transition-transform duration-700 group-hover:translate-x-full" />
            </Link>

            <Link
              href="/chat"
              className="group relative overflow-hidden border-2 border-coffee-gray/30 bg-transparent px-12 py-5 text-lg font-semibold text-coffee-gray backdrop-blur-sm transition-all duration-500 hover:scale-105 hover:border-coffee-orange hover:bg-coffee-orange/10 hover:text-white hover:shadow-[0_8px_30px_rgba(243,164,36,0.2)]"
            >
              <span className="relative z-10">Assistant Intelligent</span>
              <div className="absolute inset-0 -translate-x-full bg-gradient-to-r from-transparent via-coffee-orange/10 to-transparent transition-transform duration-700 group-hover:translate-x-full" />
            </Link>
          </div>

          {/* Enhanced Scroll Indicator */}
          <div className="absolute bottom-12">
            <div className="flex flex-col items-center gap-2 text-coffee-gray/60 transition-colors hover:text-coffee-orange">
              ...
              <div className="flex h-10 w-6 items-start justify-center rounded-full border-2 border-current p-1">
                <div className="h-2 w-1 animate-scroll-down rounded-full bg-current" />
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Mission Section */}
      <section className="relative w-full bg-coffee-dark py-20">
      ...
      {/* Philosophy Section */}
      <section className="relative w-full overflow-hidden bg-coffee-bg py-20">
        {/* Decorative coffee steam effect */}
      ...
      <section className="relative w-full bg-coffee-dark py-24">
        <div className="container mx-auto px-6">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {/* Service 1 */}
            <div className="group relative overflow-hidden rounded-lg bg-coffee-accent p-8 transition-all duration-300 hover:bg-coffee-accent/80 hover:shadow-[0_8px_30px_rgba(243,164,36,0.2)]">
              ...
              <h4 className="mb-3 text-xl font-semibold text-white">Vente & Location de Machines</h4>
              <p className="text-coffee-gray">
                Équipements professionnels Keurig, Lavazza et plus. Vente, location et service d'installation complet.
              </p>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-lg bg-coffee-accent p-8 transition-all duration-300 hover:bg-coffee-accent/80 hover:shadow-[0_8px_30px_rgba(243,164,36,0.2)]">
              ...
              <h4 className="mb-3 text-xl font-semibold text-white">Produits Premium</h4>
              <p className="text-coffee-gray">
                Café Bodecker écologique, Lavazza, thés et chocolats chauds. Distribution et livraison régulière.
              </p>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-lg bg-coffee-accent p-8 transition-all duration-300 hover:bg-coffee-accent/80 hover:shadow-[0_8px_30px_rgba(243,164,36,0.2)]">
              ...
              <h4 className="mb-3 text-xl font-semibold text-white">Entretien & Maintenance</h4>
              <p className="text-coffee-gray">
                Service d'entretien rapide et sans égal. Réparations, nettoyage et support technique disponible.
              </p>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-lg bg-coffee-accent p-8 transition-all duration-300 hover:bg-coffee-accent/80 hover:shadow-[0_8px_30px_rgba(243,164,36,0.2)]">
              ...
              <h4 className="mb-3 text-xl font-semibold text-white">Service Express</h4>
              <p className="text-coffee-gray">
                Intervention rapide en cas de besoin. Nous sommes des gens accessibles, pas une boîte vocale.
              </p>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-lg bg-coffee-accent p-8 transition-all duration-300 hover:bg-coffee-accent/80 hover:shadow-[0_8px_30px_rgba(243,164,36,0.2)]">
              ...
              <h4 className="mb-3 text-xl font-semibold text-white">Dégustations Gratuites</h4>
              <p className="text-coffee-gray">
                Service de dégustation gratuite pour découvrir nos profils de café et trouver celui qui convient à votre équipe.
              </p>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-lg bg-coffee-accent p-8 transition-all duration-300 hover:bg-coffee-accent/80 hover:shadow-[0_8px_30px_rgba(243,164,36,0.2)]">
              ...
              <h4 className="mb-3 text-xl font-semibold text-white">Formation & Support</h4>
              <p className="text-coffee-gray">
                Formation complète pour votre équipe et support continu pour optimiser votre expérience café.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Contact Section */}
      <section className="relative w-full bg-coffee-bg py-24">
        <div className="container mx-auto px-6">
      ...
      {/* Footer */}
      <footer className="relative w-full bg-coffee-bg border-t border-coffee-gray/10 py-12">
        <div className="container mx-auto px-6">
